...
if edit5.Text=edit6.Text then
      begin
      showmessage('KAYDIT OLDUNUZ TEBRÝK EDERÝZ!') ;

      ADOTable1.Append;
    ADOTable1.FieldByName('ÝSÝM').AsString := Edit1.Text;
    ADOTable1.FieldByName('SOY').AsString := Edit2.Text;
     ADOTable1.FieldByName('EMAÝL').AsString := Edit3.Text;
    ...
    ShowMessage('Lütfen programý yeniden baþlatýnýz ');
 form6.Close;
    form1.Show;
